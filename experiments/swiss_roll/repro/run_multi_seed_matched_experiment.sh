...
EXACT_CME_INDIV_NOISE_OUTDIR=experiments/swiss_roll/data/experiment_outputs/seeds/matched/exact_cme_process_indiv_noise
BAGGED_GP_OUTDIR=experiments/swiss_roll/data/experiment_outputs/seeds/matched/bagged_gp
INDEPENDENT_BAGGED_GP_OUTDIR=experiments/swiss_roll/data/experiment_outputs/seeds/matched/bagged_gp_independent_bags
VARIATIONAL_CME_OUTDIR=experiments/swiss_roll/data/experiment_outputs/seeds/matched/variational_cme_process
VARIATIONAL_CME_INDIV_NOISE_OUTDIR=experiments/swiss_roll/data/experiment_outputs/seeds/matched/variational_cme_process_indiv_noise
