...
GP_REGRESSION_OUTDIR=experiements/swiss_roll/data/experiment_outputs/seeds/gp_regression
...
do
  ...
  python experiemnts/swiss_roll/run_experiment.py --seed=$SEED --cfg=$GP_REGRESSION_CFG --o=$GP_REGRESSION_OUTDIR/$DIRNAME
