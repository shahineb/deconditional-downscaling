...
VARIATIONAL_CMP_INDIV_NOISE_CFG=experiments/downscaling/config/variational_cmp_indiv_noise.yaml
...
VARIATIONAL_CMP_INDIV_NOISE_OUTDIR=experiments/downscaling/data/experiment_outputs/seeds/variational_cmp_indiv_noise
...
do
  DIRNAME=seed_$SEED
  python experiments/downscaling/run_experiment.py --seed=$SEED --cfg=$VARIATIONAL_CMP_INDIV_NOISE_CFG --o=$VARIATIONAL_CMP_INDIV_NOISE_OUTDIR/$DIRNAME --plot
